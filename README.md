...
**Prerequisites:** A Kubernetes cluster (`kubectl` reachable), [Podman](https://podman.io/) + `vfkit` (or Rancher Desktop), [Tilt](https://docs.tilt.dev/install.html), and the [GitHub CLI](https://cli.github.com/) for ghcr.io auth.
